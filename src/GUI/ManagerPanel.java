...
public class ManagerPanel extends JPanel {
	...
	public ManagerPanel() {
		...
		checkExpenses = new CheckExpenses();
		removeHelper = new RemoveHelper();
		
		setLayout(null);
		card = new CardLayout(0,0);
		JMenuBar menuBar = new JMenuBar();
		menuBar.setBounds(0, 0, 812, 22);
		add(menuBar);
		...
		JMenuItem mntmCheckExpenses = new JMenuItem("Check Expenses");
		mnNewMenu.add(mntmCheckExpenses);
		
		JMenuItem mntmNewMenuItem_1 = new JMenuItem("Remove Helper");
		mntmNewMenuItem_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				removeHelper.reload();
				card.show(contentPane, "RemoveHelper");
			}
		});
		...
		mntmCheckExpenses.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				checkExpenses.reload();
				card.show(contentPane, "CheckExpenses");
			}
		});
 
		contentPane = new JPanel();
		contentPane.setBounds(0, 22, 816, 545);
		add(contentPane);
		...
		contentPane.add(checkExpenses,"CheckExpenses");
		contentPane.add(removeHelper,"RemoveHelper");
